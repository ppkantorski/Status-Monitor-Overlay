	...
	namespace elm {
		...
		public:
			...
			virtual void draw(gfx::Renderer *renderer) override {
				...
				renderer->drawRect(this->getX(), this->getY(), this->getWidth(), 1, a({ 0x7, 0x7, 0x7, 0x7 }));
				renderer->drawRect(this->getX(), this->getY() + this->getHeight(), this->getWidth(), 1, a({ 0x7, 0x7, 0x7, 0x7 }));
